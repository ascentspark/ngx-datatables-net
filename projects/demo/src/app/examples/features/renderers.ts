...
// value through DomSanitizer.sanitize(SecurityContext.HTML, value)
// for the 'display' and 'filter' render types only, keeping raw
// data for sort/type so ordering stays correct.`,
    },
  ];
}
